document.addEventListener('DOMContentLoaded', () => {
    ...
    function cpuAttack() {
        ...
        if (cpuHuntQueue.length > 0) {
            ...
            let moves = availableCPUShots.filter(id => (Math.floor(id/10) + (id%10)) % 2 === 0);
            let pool = moves.length > 0 ? moves : availableCPUShots;
